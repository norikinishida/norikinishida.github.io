...
app.constant('CONSTANTS', {
    ...
    relations: [
        ...
        // Basic
        "ELABORATION",
        "EXEMPLIFICATION", // To be merged with ELABORATION in v3
        "DEFINITION", // To be merged with ELABORATION in v3
        "CONTRAST", // To be merged with COMPARISON in v3
        "COMPARISON",
        "CAUSE-RESULT-REASON", // To be renamed as CAUSE-RESULT in v3
        "CONDITION",
        // "TEMPORAL", // To be added in v3
        "JOINT",
        "ENABLEMENT",
        "MANNER-MEANS",
        "ATTRIBUTION",
        // Meta
        "BACKGROUND",
        "EVALUATION-CONCLUSION", // To be renamed as FINDINGS in v3
        // Functional
